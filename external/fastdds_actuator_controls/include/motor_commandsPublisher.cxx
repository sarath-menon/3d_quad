...
motor_commandsPublisher::motor_commandsPublisher()
    : participant_(nullptr), publisher_(nullptr), topic_(nullptr),
      writer_(nullptr), type_(new actuator_commandsPubSubType()) {}
...
bool motor_commandsPublisher::init() {
  ...
  // CREATE THE TOPIC
  topic_ = participant_->create_topic("motor_commandsTopic",
  ...
  std::cout << "actuator_commands DataWriter created." << std::endl;
  return true;
}
...
void motor_commandsPublisher::run(actuator_commands st) {

  while (listener_.matched == 0) {
    std::cout << "actuator_commands DataWriter waiting for DataReaders."
              << std::endl;
